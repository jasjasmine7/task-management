<div>
    <div class="flex items-center justify-between top">
        <h10 class="mt-4 ml-4 text-2xl font-semibold text-left text-red-900">Activity Monitoring</h10>
    ...
    <path d="M8.574 11.024h6.852a2.075 2.075 0 0 0 1.847-1.086 1.9 1.9 0 0 0-.11-1.986L13.736 2.9a2.122 2.122 0 0 0-3.472 0L6.837 7.952a1.9 1.9 0 0 0-.11 1.986 2.074 2.074 0 0 0 1.847 1.086Zm6.852 1.952H8.574a2.072 2.072 0 0 0-1.847 1.087 1.9 1.9 0 0 0 .11 1.985l3.426 5.05a2.123 2.123 0 0 0 3.472 0l3.427-5.05a1.9 1.9 0 0 0 .11-1.985 2.074 2.074 0 0 0-1.846-1.087Z"/>
        ...
        <tbody>
            <tr class="text-black bg-white border-b">
                ...
                <td class="px-6 py-4">
                    03/18/24 - 07:45:00 AM

                </td>
                <td class="px-6 py-4">
                    03/18/24 - 07:45:00 PM
                </td>
                <td class="px-6 py-4">
     ...
     <!---- DELETE ---->
            ...
            <tr class="text-black bg-gray-100 border-b">
                ...
                <td class="px-6 py-4">
                    03/18/24 - 07:00:00 AM
                </td>
                <td class="px-6 py-4">
                    03/18/24 - 05:00:00 PM
                </td>
                <td class="px-6 py-4">
                    8 hours
                    {{-- <select name="filter" id="filter" class="bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">
    ...
    <!---- EDIT ---->
       ...
       <!--- EDIT CONTENT -->
            ...
            <tr class="text-black bg-white border-b">
                ...
                <td class="px-6 py-4">
                    03/18/24 - 10:00:00 AM
                </td>
                <td class="px-6 py-4">
                    03/18/24 - 06:00:00 PM
                </td>
                <td class="px-6 py-4">
       ...
       <!--- EDIT CONTENT -->
            ...
            <tr class="text-black bg-gray-100 border-b">
                ...
                <td class="px-6 py-4">
                    03/18/24 - 07:30:00 AM
                </td>
                <td class="px-6 py-4">
                    03/18/24 - 05:30:00 PM
                </td>
                <td class="px-6 py-4">
       ...
       <!--- EDIT CONTENT -->
            ...
            <tr class="text-black bg-white border-b">
                ...
                <td class="px-6 py-4">
                    03/18/24 - 09:33:00 AM
                </td>
                <td class="px-6 py-4">
                    03/18/24 - 04:45:00 PM
                </td>
                <td class="px-6 py-4">
